...
1.  **Formulario Estructurado en Pestañas (Tabs):** Organiza el flujo de trabajo en:
    - _Horario y Calendario:_ Configuración del semestre, gestión académica y carga física de aulas.
    - _Planificación Semestral:_ La grilla editable interactiva de dosificación por unidad/sesión.
    - _Vista de Impresión (Preview):_ Formato estandarizado institucional para la exportación y firma en PDF.
