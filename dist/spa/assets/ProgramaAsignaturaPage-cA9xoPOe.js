import { Q as Z, a as O } from './QBreadcrumbs-hC_CbLw4.js'
import {
  aj as h,
  av as K,
  e as X,
...
import { Q as re, a as Q } from './QTabs-XUKDyJ9p.js'
import { Q as j } from './QBanner-B_wUJwQn.js'
import { Q as se, a as B } from './QTabPanels-B60gN2RY.js'
import { Q as ie, a as Y } from './QItem-Ct2yf9BL.js'
import { Q as ne } from './QList-Bxl9uK2v.js'
import { Q as de } from './QPage-CXkddPvY.js'
import { u as ce } from './grupos-BcU3JZSD.js'
import { E as H, a as A } from './jspdf.plugin.autotable-C96cyzlN.js'
...
const ge = { class: 'row items-center q-mb-lg animate-in' },
                              ...
                              { name: 'competencias', class: 'q-pa-lg' },
                              {
                                default: r(() => [
                                  a(
                                    ...
                                    {
                                      avatar: r(() => [a(v, { name: 'groups', color: 'purple' })]),
                                      default: r(() => [
                                        e[21] ||
                                          (e[21] = o(
                                            'span',
                                  ...
                                  o('div', null, [
                                    ...
                                    d.value.elementos_competencia.length
                                      ...
                                      : (f(),
                                        E('div', Te, [
                                          a(v, { name: 'playlist_add', size: '48px' }),
                                          e[24] ||
                                            (e[24] = o(
                                              'p',
                                              null,
                              ...
                              { name: 'bibliografia', class: 'q-pa-lg' },
                              {
                                default: r(() => [
                                  ...
                                  d.value.bibliografia_complementaria.length
                                    ...
                                    : (f(),
                                      E('div', ia, [
                                        a(v, { name: 'library_books', size: '48px' }),
                                        e[41] ||
                                          (e[41] = o(
                                            'p',
                                            null,
  ...
  Na = me(fa, [['__scopeId', 'data-v-884a8a83']])
