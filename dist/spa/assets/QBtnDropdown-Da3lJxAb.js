...
import { Q as _ } from './QBtnGroup-DpqpKo7X.js'
import { Q as j } from './QMenu-BQiozE0c.js'
...
const G = I({
  ...
  setup(e, { slots: t, emit: o }) {
    ...
    return (
      ...
      () => {
        const n = [l(P, { class: v.value, name: e.dropdownIcon || a.$q.iconSet.arrow.dropdown })]
        return (
          e.disableDropdown !== !0 &&
            n.push(
              l(
          ...
          e.split === !1
            ? l(
                ...
                { default: () => V(t.label, []).concat(n), loading: t.loading },
              )
            : l(
                _,
                {
