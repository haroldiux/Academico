...
import { Q as _ } from './QBtnGroup-vR5Xmbr5.js'
import { Q as j } from './QMenu-C5EVwErB.js'
...
const T = R({
  ...
  setup(e, { slots: t, emit: o }) {
    const { proxy: a } = x(),
      ...
      f = u(() => {
        const n = {
          ...
          'aria-label':
            e.toggleAriaLabel || a.$q.lang.label[i.value === !0 ? 'collapse' : 'expand'](e.label),
        }
        return (
          (e.disable === !0 ||
      ...
      v = u(
        () =>
          ...
          (i.value === !0 && e.noIconAnimation === !1 ? ' rotate-180' : '') +
    ...
    return (
      Object.assign(a, { show: g, hide: r, toggle: Q }),
      P(() => {
        e.modelValue === !0 && g()
      }),
      () => {
        const n = [l(V, { class: v.value, name: e.dropdownIcon || a.$q.iconSet.arrow.dropdown })]
        return (
          e.disableDropdown !== !0 &&
            n.push(
              l(
          ...
          e.split === !1
            ? l(
                ...
                { default: () => M(t.label, []).concat(n), loading: t.loading },
              )
            : l(
                _,
                {
