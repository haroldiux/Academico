...
function ht() {
  ...
  let A = Et()
  o.isSupported =
    typeof _t == 'function' && typeof te == 'function' && pe && pe.createHTMLDocument !== void 0
  const {
    MUSTACHE_EXPR: Te,
    ERB_EXPR: de,
    TMPLIT_EXPR: Ee,
    ...
    ye = function () {
      ...
      if (!(G && G === e)) {
        if (
          ...
          (Le = y(e, 'ALLOWED_NAMESPACES') ? r({}, e.ALLOWED_NAMESPACES, Ie) : Ut),
          (Oe = y(e, 'ADD_URI_SAFE_ATTR') ? r(I(Ke), e.ADD_URI_SAFE_ATTR, p) : Ke),
          ($e = y(e, 'ADD_DATA_URI_TAGS') ? r(I(qe), e.ADD_DATA_URI_TAGS, p) : qe),
          ...
          e.FORBID_CONTENTS && (b === Re && (b = I(b)), r(b, e.FORBID_CONTENTS, p)),
          e.ADD_FORBID_CONTENTS && (b === Re && (b = I(b)), r(b, e.ADD_FORBID_CONTENTS, p)),
          Se && (T['#text'] = !0),
