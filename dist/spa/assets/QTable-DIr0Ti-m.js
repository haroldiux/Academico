...
import { Q as wt } from './QList-Bxl9uK2v.js'
import { u as _t, a as Ct, c as De, Q as Pt } from './QSelect-BVdhM4WH.js'
import { Q as qt } from './QLinearProgress-DDgwSD3L.js'
import { u as Rt, a as kt, b as Tt } from './use-fullscreen-DBkJWwsi.js'
const ll = z({
    name: 'QTd',
    ...
    setup(e, { slots: l }) {
      ...
      return () => {
        ...
        const i = r.vnode.key,
          S = (e.props.colsMap !== void 0 ? e.props.colsMap[i] : null) || e.props.col
        if (S === void 0) return
        const { row: s } = e.props
        return o('td', { class: g.value + S.__tdClass(s), style: S.__tdStyle(s) }, H(l.default))
      }
    },
  }),
  xt = z({
    ...
    setup(e, { slots: l, emit: r }) {
      ...
      return () => {
        if (e.props === void 0)
          return o(
            'th',
            { class: e.autoWidth === !0 ? 'q-table--col-auto-width' : '', onClick: S },
            H(l.default),
          )
        let s, c
        const u = g.vnode.key
        ...
        const h = {
          ...
          style: s.headerStyle,
          onClick: (n) => {
            ;(s.sortable === !0 && e.props.sort(s), S(n))
          },
        }
        return o('th', h, c)
      }
...
const Ot = { list: wt, table: Bt },
  Mt = ['list', 'table', '__qtable'],
  Lt = z({
    name: 'QVirtualScroll',
    props: {
      ..._t,
      type: { type: String, default: 'list', validator: (e) => Mt.includes(e) },
    ...
    setup(e, { slots: l, attrs: r }) {
      ...
      const i = $(null),
        ...
        } = Ct({ virtualScrollLength: S, getVirtualScrollTarget: R, getVirtualScrollEl: C }),
        n = f(() => {
          if (S.value === 0) return []
      ...
      function F() {
        ...
        return (l.before !== void 0 && (B = l.before().concat(B)), St(l.after, B))
      }
      return (
        dt(() => {
          c()
        ...
        () => {
          ...
          return e.type === '__qtable'
            ? Ve({ ref: i, class: 'q-table__middle ' + m.value }, F())
            : o(Ot[e.type], { ...r, ref: i, class: [r.class, m.value], ..._.value }, F)
        }
      )
    },
  })
...
function jt(e, l, r, g) {
  ...
  function s(c) {
    ...
    if (mt(c) === !0) (c.sortOrder && (u = c.sortOrder), (c = c.name))
    else {
      const m = r.value.find((_) => _.name === c)
      m?.sortOrder && (u = m.sortOrder)
    }
  ...
  return { columnToSort: i, computedSortMethod: S, sort: s }
}
...
function Ht(e, l) {
  ...
  function u(n = {}) {
    Le(() => {
      g('request', {
        pagination: n.pagination || S.value,
...
function $t(e, l, r, g, i, S) {
  const {
      props: s,
      emit: c,
      proxy: { $q: u },
    } = e,
    h = f(() => (g.value === !0 ? r.value.rowsNumber || 0 : S.value)),
    n = f(() => {
    ...
    R = f(() => (m.value === 0 ? !0 : r.value.page >= C.value)),
    w = f(() =>
  ...
  function B() {
    const { page: T, rowsPerPage: x } = r.value
    m.value > 0 && T * x < h.value && i({ page: T + 1 })
  }
  function O() {
    i({ page: C.value })
  }
...
function Gt(e, l) {
  ...
  return { isRowExpanded: g, setExpanded: i, updateExpanded: S }
}
const Yt = { visibleColumns: Array }
function Jt(e, l, r) {
  const g = f(() => {
  ...
  return { colList: g, computedCols: i, computedColsMap: S, computedColspan: s }
}
...
const al = z({
  ...
  setup(e, { slots: l, emit: r }) {
    const g = ee(),
      ...
      h = $(null),
      n = $(null),
      m = f(() => e.grid !== !0 && e.virtualScroll === !0),
      _ = f(
        () =>
          ' q-table__card' +
          (S.value === !0 ? ' q-table__card--dark q-dark' : '') +
          (e.square === !0 ? ' q-table--square' : '') +
          (e.flat === !0 ? ' q-table--flat' : '') +
          (e.bordered === !0 ? ' q-table--bordered' : ''),
      ),
    ...
    const {
      ...
      te = f(() => {
        ...
        return (
          e.filter && (t = T.value(t, e.filter, L.value, A)),
      ...
      { colList: He, computedCols: L, computedColsMap: ye, computedColspan: he } = Jt(e, y, j),
    ...
    function Ge() {
      ...
      if (m.value === !0) {
        ...
        if (d !== void 0) {
          const k = o('tbody', d({ cols: L.value }))
          b.before = t === null ? () => k : () => [t()].concat(k)
        } else t !== null && (b.before = t)
        return (
          v !== void 0 && (b.after = () => o('tbody', v({ cols: L.value }))),
          o(
            Lt,
            {
              ref: n,
    ...
    function _e(t, a, d) {
      ...
      const k = l['body-cell'],
        P = L.value.map((q) => {
          const V = l[`body-cell-${q.name}`],
            X = V !== void 0 ? V : k
          return X !== void 0
            ? X(Ze({ key: v, row: t, pageIndex: d, col: q }))
      ...
      const M = { key: v, class: { selected: b } }
      if (
        (e.onRowClick !== void 0 &&
          ((M.class['cursor-pointer'] = !0),
          (M.onClick = (q) => {
            r('rowClick', q, t, d)
          })),
        ...
        e.tableRowStyleFn !== void 0 && (M.style = e.tableRowStyleFn(t)),
        e.tableRowClassFn !== void 0)
      ) {
    ...
    function Xe() {
      ...
      return (
        a !== void 0 && (v = a({ cols: L.value }).concat(v)),
        d !== void 0 && (v = v.concat(d({ cols: L.value }))),
        o('tbody', v)
      )
    }
    function Ce(t) {
    ...
    function et() {
      ...
      if (t !== void 0) return o('div', { class: k }, [t(E.value)])
      let P
      if (
        (b === !0
          ? (P = v(E.value).slice())
          : ((P = []),
            a !== void 0
              ? P.push(o('div', { class: 'q-table__control' }, [a(E.value)]))
              : e.title &&
                P.push(
        ...
        d !== void 0 &&
          ...
          P.push(o('div', { class: 'q-table__control' }, [d(E.value)]))),
        P.length !== 0)
      )
        return o('div', { class: k }, P)
    }
    const Pe = f(() => (me.value === !0 ? null : Qe.value))
    function qe() {
      const t = tt()
      return (
        e.loading === !0 &&
    ...
    function ve(t) {
      return (
        ...
        Se.value === !0 && N(t, 'selected', () => Pe.value, Re),
        t
      )
    }
    function Re(t) {
      ;(me.value === !0 && (t = !1), I(D.value.map(u.value), D.value, t))
    }
    const J = f(() => {
      const t = [
    ...
    function lt() {
      ...
      const t = l.bottom
      if (t !== void 0) return o('div', { class: p }, [t(E.value)])
      const a =
      ...
      if (
        ...
        ((a = [
          o('span', d !== 0 ? { class: 'q-table__bottom-item' } : {}, [
            d ? v(W.value + 1, Math.min(K.value, Y.value), Y.value) : v(1, be.value, Y.value),
          ]),
        ]),
        d !== 0 && G.value > 1)
      ) {
