import { ap as i } from './index-CVgKKHHv.js'
function o() {
  const t =
  ...
  let n = 'unknown'
  const e = t ? t.type || t.effectiveType : null
...
class s extends i {
  constructor() {
    ;(super(),
      (this.handleOnline = () => {
        const e = { connected: !0, connectionType: o() }
        this.notifyListeners('networkStatusChange', e)
      }),
      (this.handleOffline = () => {
        const n = { connected: !1, connectionType: 'none' }
  ...
  async getStatus() {
    ...
    const n = window.navigator.onLine,
      e = o()
    return { connected: n, connectionType: n ? e : 'none' }
  }
}
const r = new s()
