...
import { Q as cl } from './QBtnToggle-CKPeH_SB.js'
import { Q as Y, a as T } from './QTabs-XUKDyJ9p.js'
import { Q as pl, a as R } from './QItem-Ct2yf9BL.js'
import { Q as Z } from './QItemLabel-DpaCr0ua.js'
import { Q as H } from './QChip-DKBiE8wd.js'
import { Q as ml } from './QList-Bxl9uK2v.js'
import { Q as O } from './QLinearProgress-DDgwSD3L.js'
import { Q as vl, a as gl } from './QTabPanels-B60gN2RY.js'
import { Q as fl } from './QPage-CXkddPvY.js'
import { C as bl } from './ClosePopup-ntdN2KQk.js'
import { u as _l } from './sedes-BvGrNuyB.js'
import { u as hl } from './carreras-3ndxH09a.js'
...
const xl = { class: 'bolivia-map-container' },
  Cl = { key: 0, class: 'map-header q-mb-md' },
  yl = { class: 'text-h6 text-weight-bold text-primary' },
  zl = { viewBox: '0 0 800 533', class: 'bolivia-map', xmlns: 'http://www.w3.org/2000/svg' },
  Sl = { class: 'tooltip-title' },
  kl = { key: 0, class: 'tooltip-content' },
  wl = { class: 'row justify-between items-center text-weight-medium' },
  Ml = { key: 1, class: 'tooltip-no-sede' },
  ql = {
    __name: 'BoliviaMapSVG',
    props: { sedesData: { type: Object, required: !0 }, title: { type: String, default: '' } },
    emits: ['select-department', 'select-sede'],
    setup(Q, { emit: B }) {
      const p = Q,
        L = B,
        S = x(!1),
        C = x(0),
        h = x(0),
        m = x({ name: '', progress: 0, sedesCount: 0, sedes: [] }),
        k = {
          pando: 'Pando',
          beni: 'Beni',
          la_paz: 'La Paz',
      ...
      function D(d) {
        const t = p.sedesData[d] || []
        if (t.length === 0) return 0
        const s = t.reduce((w, V) => w + (V.progreso || 0), 0)
        return Math.round(s / t.length)
      }
      function A(d) {
        return d >= 80 ? 'positive' : d >= 60 ? 'warning' : 'negative'
      }
      function v(d) {
        if ((p.sedesData[d] || []).length === 0) return { 'dept-empty': !0 }
        const s = D(d)
        return {
          'dept-high': s >= 80,
          'dept-medium': s >= 60 && s < 80,
          'dept-low': s < 60,
          'has-sede': !0,
        }
      }
      function g(d, t) {
        const s = p.sedesData[d] || []
        ;((m.value = { name: k[d], progress: D(d), sedesCount: s.length, sedes: s }),
          (C.value = t.clientX + 15),
          (h.value = t.clientY + 15),
          (S.value = !0))
      }
      function f() {
        S.value = !1
      ...
      function b(d) {
        ...
        t.length !== 0 &&
          (t.length === 1
            ? L('select-sede', t[0])
            : t.length > 1 && L('select-department', { id: d, name: k[d], sedes: t }))
      }
      return (d, t) => (
        u(),
        c('div', xl, [
          Q.title ? (u(), c('div', Cl, [a('div', yl, i(Q.title), 1)])) : F('', !0),
          (u(),
          c('svg', zl, [
            a('g', null, [
              a(
                'path',
                {
                  ...
                  onClick: t[0] || (t[0] = (s) => b('pando')),
                  onMouseenter: t[1] || (t[1] = (s) => g('pando', s)),
                  onMouseleave: f,
                },
                null,
                34,
              ...
              a(
                'path',
                {
                  ...
                  onClick: t[2] || (t[2] = (s) => b('beni')),
                  onMouseenter: t[3] || (t[3] = (s) => g('beni', s)),
                  onMouseleave: f,
                },
                null,
                34,
              ...
              a(
                'path',
                {
                  ...
                  onClick: t[4] || (t[4] = (s) => b('la_paz')),
                  onMouseenter: t[5] || (t[5] = (s) => g('la_paz', s)),
                  onMouseleave: f,
                },
                null,
                34,
              ...
              a(
                'path',
                {
                  class: _(['department', v('cochabamba')]),
                  ...
                  onClick: t[6] || (t[6] = (s) => b('cochabamba')),
                  onMouseenter: t[7] || (t[7] = (s) => g('cochabamba', s)),
                  onMouseleave: f,
                },
                null,
                34,
              ...
              a(
                'path',
                {
                  class: _(['department', v('santa_cruz')]),
                  ...
                  onClick: t[8] || (t[8] = (s) => b('santa_cruz')),
                  onMouseenter: t[9] || (t[9] = (s) => g('santa_cruz', s)),
                  onMouseleave: f,
                },
                null,
                34,
              ...
              a(
                'path',
                {
                  ...
                  onClick: t[10] || (t[10] = (s) => b('oruro')),
                  onMouseenter: t[11] || (t[11] = (s) => g('oruro', s)),
                  onMouseleave: f,
                },
                null,
                34,
              ...
              a(
                'path',
                {
                  ...
                  onClick: t[12] || (t[12] = (s) => b('potosi')),
                  onMouseenter: t[13] || (t[13] = (s) => g('potosi', s)),
                  onMouseleave: f,
                },
                null,
                34,
              ...
              a(
                'path',
                {
                  ...
                  onClick: t[14] || (t[14] = (s) => b('tarija')),
                  onMouseenter: t[15] || (t[15] = (s) => g('tarija', s)),
                  onMouseleave: f,
                },
                null,
                34,
              ...
              a(
                'path',
                {
                  class: _(['department', v('chuquisaca')]),
                  ...
                  onClick: t[16] || (t[16] = (s) => b('chuquisaca')),
                  onMouseenter: t[17] || (t[17] = (s) => g('chuquisaca', s)),
                  onMouseleave: f,
                },
                null,
                34,
            ...
            ? (u(),
              c(
                'div',
                {
                  key: 1,
                  class: 'map-tooltip',
                  style: al({ left: C.value + 'px', top: h.value + 'px' }),
                },
                [
                  a('div', Sl, i(m.value.name), 1),
                  m.value.sedesCount > 0
                    ? (u(),
                      c('div', kl, [
                        t[18] ||
                          (t[18] = a(
                            ...
                            'Haga click para ver detalles de:',
                            -1,
                          )),
                        (u(!0),
                        c(
                          ...
                          q(
                            ...
                            (s) => (
                              u(),
                              c('div', { key: s.id, class: 'tooltip-sede-item q-mb-sm' }, [
                                a('div', wl, [
                                  a('span', null, i(s.nombre || 'Sede'), 1),
                                  a('span', null, i(s.progreso) + '%', 1),
                                ]),
                                n(
                                  O,
                                  {
                                    value: s.progreso / 100,
                                    color: A(s.progreso),
                                    rounded: '',
                                    size: '4px',
                                  },
                    ...
                    : (u(), c('div', Ml, 'Sin sedes registradas')),
                ],
                4,
              ))
            : F('', !0),
          t[19] ||
            (t[19] = tl(
              '<div class="map-legend" data-v-99361823><div class="legend-title" data-v-99361823>Nivel de Cumplimiento</div><div class="legend-items" data-v-99361823><div class="legend-item" data-v-99361823><span class="legend-color" style="background:#22c55e;" data-v-99361823></span><span data-v-99361823>Excelente (+80%)</span></div><div class="legend-item" data-v-99361823><span class="legend-color" style="background:#eab308;" data-v-99361823></span><span data-v-99361823>Regular (60-79%)</span></div><div class="legend-item" data-v-99361823><span class="legend-color" style="background:#ef4444;" data-v-99361823></span><span data-v-99361823>Crítico (-60%)</span></div></div></div>',
              1,
            )),
        ])
      )
  ...
  Ql = J(ql, [['__scopeId', 'data-v-99361823']]),
  Ll = { class: 'row items-center q-mb-lg' },
  Dl = { class: 'col' },
  Vl = { class: 'q-ma-none text-weight-bold' },
  Pl = { class: 'col-auto' },
  $l = { class: 'row q-col-gutter-md q-mb-lg' },
  jl = { class: 'stat-card' },
  Tl = { class: 'stat-label' },
  Bl = { class: 'stat-value' },
  Al = { class: 'row q-mb-lg' },
  Nl = { class: 'col-12' },
  Ul = { key: 0, class: 'map-section' },
  El = { class: 'row q-col-gutter-lg' },
  Rl = { class: 'col-12 col-md-7' },
  Ol = { class: 'col-12 col-md-5' },
  Fl = { class: 'text-subtitle1 text-weight-bold q-mb-md' },
  Gl = { key: 1, class: 'sedes-grid' },
  Xl = ['onClick'],
  Yl = { class: 'sede-header' },
  Zl = { class: 'sede-avatar' },
  Hl = { class: 'sede-info' },
  Jl = { class: 'sede-nombre' },
  Wl = { class: 'sede-codigo' },
  Il = { class: 'sede-stats' },
  Kl = { class: 'sede-stat' },
  le = { class: 'stat-num' },
  ee = { class: 'sede-stat' },
  ...
  se = { class: 'stat-num' },
  oe = { class: 'text-h6' },
  ne = { class: 'text-center q-pa-md' },
  re = { class: 'text-h6' },
  ie = { class: 'text-caption text-grey q-mb-md' },
  de = {
    __name: 'SedesPage',
    setup(Q) {
      const B = sl(),
        ...
        v = N(() => {
          ...
          return (
            p.sedes.forEach((l) => {
              const e = f(l.nombre)
              e && o[e] && o[e].push({ ...l, progreso: d(l.id, k.value) })
            }),
            o
          )
        }),
        g = N(() => {
          const o = {}
          return (
            Object.entries(v.value).forEach(([l, e]) => {
              e.length > 0 && (o[l] = e)
            }),
            o
          )
      ...
      function f(o) {
        ...
        return l.includes('cochabamba') || l.includes('cercado') || l.includes('ivirga')
          ? 'cochabamba'
          : l.includes('la paz') || l.includes('el alto')
            ? 'la_paz'
            : l.includes('santa cruz')
              ? 'santa_cruz'
              : l.includes('oruro')
                ? 'oruro'
                : l.includes('potosí') || l.includes('potosi')
                  ? 'potosi'
                  : l.includes('sucre') || l.includes('chuquisaca')
                    ? 'chuquisaca'
                    : l.includes('tarija')
                      ? 'tarija'
                      : l.includes('trinidad') || l.includes('beni')
                        ? 'beni'
                        : l.includes('cobija') || l.includes('pando')
                          ? 'pando'
                          : l.includes('guaya')
                            ? 'beni'
                            : l.includes('puerto') || l.includes('quija')
                              ? 'santa_cruz'
                              : null
      }
      ol(() => {
        ;(p.fetchSedes(), L.fetchCarreras())
      })
      const b = N(() => [
        {
          label: 'Total Sedes',
          value: p.stats.total_sedes,
          icon: 'location_city',
          color: 'purple',
        },
        {
          label: 'Sedes Activas',
          value: p.stats.sedes_activas,
          icon: 'check_circle',
          color: 'green',
        },
        { label: 'Total Carreras', value: p.stats.total_carreras, icon: 'school', color: 'orange' },
        { label: 'Total Docentes', value: p.stats.total_docentes, icon: 'people', color: 'blue' },
      ])
      function d(o, l = 'doc') {
        const e = {
          doc: {
      ...
      function s(o) {
        ...
        const l = o.reduce((e, y) => e + (y.progreso || 0), 0)
        return Math.round(l / o.length)
      }
      function w(o) {
        return o >= 80 ? 'positive' : o >= 60 ? 'warning' : 'negative'
      }
      function V(o) {
        return D[o] || o
      }
      ...
      function I(o, l) {
        l.length === 1
          ? P(l[0])
          : l.length > 1 &&
            ((h.value = { id: o, name: V(o), sedes: l }), (m.value = l[0].id), (C.value = !0))
      }
      function K(o) {
        ;((h.value = o), (m.value = o.sedes[0]?.id), (C.value = !0))
      }
      function ll(o) {
        P(o)
      }
      function el() {
        const o = h.value?.sedes.find((l) => l.id === m.value)
        o && ((C.value = !1), P(o))
      }
      function P(o) {
        B.push({ path: '/vicerrector/reportes', query: { sedeId: o.id, sedeName: o.nombre } })
      }
      return (o, l) => (
        u(),
        $(
          ...
          { class: 'q-pa-lg' },
          {
            default: r(() => [
              a('div', Ll, [
                a('div', Dl, [
                  a('h4', Vl, [
                    n(j, { name: 'map', size: '36px', color: 'primary', class: 'q-mr-sm' }),
                    l[5] || (l[5] = a('span', { class: 'text-gradient' }, 'Mapa de Sedes', -1)),
                  ]),
                  l[6] ||
                    (l[6] = a(
                      'p',
              ...
              a('div', $l, [
                ...
                c(
                  ...
                  q(
                    ...
                    (e) => (
                      u(),
                      c('div', { key: e.label, class: 'col-12 col-md-3' }, [
                        a('div', jl, [
                          a(
                            'div',
                            { class: _(['stat-icon', e.color]) },
                            [n(j, { name: e.icon, size: '24px' }, null, 8, ['name'])],
                            2,
                          ),
                          a('p', Tl, i(e.label), 1),
                          a('p', Bl, i(e.value), 1),
              ...
              a('div', Al, [
                a('div', Nl, [
                  n(
                    ...
                    {
                      modelValue: k.value,
                      'onUpdate:modelValue': l[1] || (l[1] = (e) => (k.value = e)),
                      dense: '',
                    ...
                    {
                      default: r(() => [
                        n(T, { name: 'doc', icon: 'description', label: 'Documentación' }),
                        n(T, { name: 'seg', icon: 'analytics', label: 'Seguimiento Docente' }),
                        n(T, { name: 'ast', icon: 'how_to_reg', label: 'Asistencia Estudiantes' }),
                      ]),
                      _: 1,
                    },
                    8,
                  ...
                  c('div', Ul, [
                    a('div', El, [
                      ...
                      a('div', Ol, [
                        n(
                          U,
                          { flat: '', bordered: '', class: 'h-full' },
                          {
                            default: r(() => [
                              n(E, null, {
                                default: r(() => [
                                  a('div', Fl, [
                                    n(j, { name: 'list', class: 'q-mr-sm' }),
                                    l[7] || (l[7] = z(' Resumen por Departamento ', -1)),
                                  ]),
                                  n(
                                    ml,
                                    { separator: '' },
                                        ...
                                        c(
                                          ...
                                          q(
                                            ...
                                            (e, y) => (
                                              ...
                                              $(
                                                pl,
                                                { key: y, clickable: '', onClick: (ue) => I(y, e) },
                                                {
                                                  default: r(() => [
                                                    n(
                                                      R,
                    ...
                    c(
                      ...
                      q(
                        ...
                        (e) => (
                          ...
                          c(
                            'div',
                            { key: e.id, class: 'sede-card', onClick: (y) => P(e) },
                            [
                              a('div', Yl, [
                                a('div', Zl, i(e.codigo), 1),
                                a('div', Hl, [
                                  a('h3', Jl, i(e.nombre), 1),
                                  a('span', Wl, 'Código: ' + i(e.codigo), 1),
                                ]),
                                n(
                                  H,
                                  {
                                    color: e.activo ? 'green-2' : 'grey-2',
                                    'text-color': e.activo ? 'green-9' : 'grey-9',
                                    size: 'sm',
                                  },
                                  {
                                    default: r(() => [z(i(e.activo ? 'Activo' : 'Inactivo'), 1)]),
                                    _: 2,
                                  },
                                  1032,
                                  ['color', 'text-color'],
                              ...
                              a('div', Il, [
                                a('div', Kl, [
                                  a('span', le, i(e.carreras_count || 0), 1),
                                  l[8] ||
                                    (l[8] = a('span', { class: 'stat-label' }, 'Carreras', -1)),
                                ]),
                                a('div', ee, [
                                  a('span', te, i(e.docentes_count || 0), 1),
                                  l[9] ||
                                    (l[9] = a('span', { class: 'stat-label' }, 'Docentes', -1)),
                                ]),
                                a('div', ae, [
                                  a('span', se, i(d(e.id)) + '%', 1),
                                  l[10] ||
                                    (l[10] = a('span', { class: 'stat-label' }, 'Progreso', -1)),
                                ]),
                              ]),
                              n(
                                O,
                        ...
                        default: r(() => [
                          n(
                            ...
                            { class: 'bg-primary text-white' },
                            {
                              default: r(() => [
                                a('div', oe, [
                                  n(j, { name: 'apartment', class: 'q-mr-sm' }),
                                  z(' ' + i(h.value?.name), 1),
                                ]),
                                l[11] ||
                                  (l[11] = a(
                                    'div',
                                    { class: 'text-caption' },
                                    'Seleccione una sede para ver reportes',
                                    -1,
                                  )),
                              ]),
                              _: 1,
                              ...
                              default: r(() => [
                                ...
                                c(
                                  ...
                                  q(
                                    ...
                                    (e) => (
                                      u(),
                                      $(T, { key: e.id, name: e.id, label: e.nombre }, null, 8, [
                                        'name',
                                        'label',
                                      ])
                                    ),
                                          ...
                                          default: r(() => [
                                            a('div', ne, [
                                              n(
                                                ...
                                                { default: r(() => [z(i(e.codigo), 1)]), _: 2 },
                                                1032,
                                                ['color'],
                                              ),
                                              a('div', re, i(e.nombre), 1),
                                              a(
                                                'div',
                                                ie,
                                                i(e.carreras || 0) +
                          ...
                          n(
                            ...
                            {
                              default: r(() => [
                                ul(n(X, { flat: '', label: 'Cancelar' }, null, 512), [[bl]]),
                                n(X, { color: 'primary', label: 'Ver Reportes', onClick: el }),
                              ]),
                              _: 1,
                            },
                          ),
  ...
  De = J(de, [['__scopeId', 'data-v-7558b7b8']])
