...
- **Android Studio**: Descarga la última versión estable (Ladybug o posterior) desde [developer.android.com/studio](https://developer.android.com/studio).
  - _Mínimo requerido por Capacitor 6: Android Studio Hedgehog (2023.1.1)_.
...
_(Este paso ya se realizó parcialmente al agregar el modo capacitor, pero es bueno recordarlo si el proyecto es nuevo en otro equipo)._
