  ...
  <q-card style="min-width: 650px; max-width: 95vw;">
    ...
    <q-card-section class="q-pa-md">
      <q-banner dense class="bg-red-1 text-red-9 q-mb-md rounded-borders">
        ...
        Este registro se activa ante <b>incumplimientos reincidentes</b> (2 semanas consecutivas en Rojo) o hallazgos graves en auditorías.
      </q-banner>
      ...
      <q-form @submit="onSubmit" class="q-gutter-md">
        ...
        <div class="row q-col-gutter-sm">
          <div class="col-12 col-md-6">
            <q-input v-model="form.asignatura" label="Asignatura" readonly outlined dense bg-color="grey-1" />
          </div>
          <div class="col-12 col-md-6">
            <q-input v-model="form.carrera" label="Carrera" readonly outlined dense bg-color="grey-1" />
          </div>
          <div class="col-12 col-md-6">
            <q-input v-model="form.docente" label="Docente Responsable" readonly outlined dense bg-color="grey-1" />
          </div>
          <div class="col-12 col-md-6">
        ...
        <div class="row q-col-gutter-sm">
           ...
           <div class="col-12 col-md-6">
              <q-input v-model="form.fechaSeguimiento" label="Fecha de Próximo Seguimiento" type="date" outlined dense />
           </div>
        </div>

        <div class="row justify-end q-gutter-sm q-mt-md">
           <div class="col-grow">
              <q-checkbox v-model="form.notificarDocente" label="Notificar formalmente al Docente" color="red" />
           </div>
