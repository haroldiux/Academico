  ...
  <q-card style="min-width: 750px; max-width: 95vw;">
    ...
    <q-card-section class="q-pa-md">
      <q-form @submit="onSubmit" class="q-gutter-md">
        ...
        <div class="row q-col-gutter-sm items-end bg-teal-1 q-pa-sm rounded-borders">
          ...
          <div class="col-12 col-md-3">
             ...
             <div class="row no-wrap q-gutter-xs">
                <q-select label="Semana" v-model="form.semana" :options="['S1','S2','S3','S4']" outlined dense class="col" />
                <q-input label="Sesión" v-model="form.sesion" type="number" outlined dense class="col" />
             </div>
          </div>
        ...
        <!-- Checklist -->
        <div class="text-subtitle2 text-teal">Verificación de Criterios (Lista de Cotejo Institucional)</div>
        ...
        <div class="row q-col-gutter-md">
           <div class="col-12 col-md-6">
              <q-file v-model="form.fotos" label="Fotografías in Situ" outlined dense multiple accept="image/*">
           ...
           <div class="col-12 col-md-6">
              <q-card flat bordered class="q-pa-sm text-center">
                 ...
                 <q-btn outline color="teal" icon="history_edu" label="Solicitar Firma en Tablet" size="sm" />
                 <q-chip v-if="form.firmado" color="positive" text-color="white" label="Firma Registrada" icon="verified" class="q-mt-sm" />
              </q-card>
           </div>
        </div>

        <q-input v-model="form.observaciones" label="Observaciones de la Práctica" type="textarea" outlined rows="2" />
