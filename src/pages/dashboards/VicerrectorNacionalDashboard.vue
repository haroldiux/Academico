          ...
          >
            <div class="sede-info">
              ...
              <div class="sede-details">
                ...
                <span class="sede-stats"
                  >{{ sede.carreras }} carreras • {{ sede.docentes }} docentes</span
                >
              </div>
            </div>
            <div class="sede-progress">
              ...
              <span
                class="progress-text"
                :class="sede.progreso >= 80 ? 'text-green' : 'text-orange'"
              >
                {{ sede.progreso }}%
              </span>
