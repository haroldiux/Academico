          ...
          <div v-for="sede in estadisticasSedes" :key="sede.id" class="sede-bar-item">
            <div class="sede-bar-info">
              ...
              <span class="sede-value">
                {{
                  vistaEstadisticas === 'progreso'
                    ? sede.progreso + '%'
                    : vistaEstadisticas === 'asignaturas'
                      ? sede.asignaturas
                      : sede.docentes
                }}
              </span>
...
function getBarWidth(sede) {
  ...
  const value =
    vistaEstadisticas.value === 'progreso'
      ? sede.progreso
      : vistaEstadisticas.value === 'asignaturas'
        ? sede.asignaturas
        : sede.docentes
