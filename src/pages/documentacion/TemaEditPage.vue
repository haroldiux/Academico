    ...
    <div class="row items-center q-mb-lg animate-in">
        ...
        <div class="row items-center q-mb-sm">
          ...
          <q-breadcrumbs>
            ...
            <q-breadcrumbs-el
              ...
              :to="`/documentacion/${asignatura?.id}`"
            />
      ...
      <div class="col-auto row q-gutter-sm items-center">
        ...
        <q-chip
          ...
          :text-color="
            saveStatus === 'saving' ? 'blue-9' : saveStatus === 'saved' ? 'green-9' : 'red-9'
          "
          size="md"
          class="q-mr-sm"
        >
          ...
          >
            <q-tab name="aprendizaje" no-caps>
              <div class="row items-center q-gutter-sm">
                ...
                <q-chip size="xs" color="purple-2" text-color="purple-9" dense class="q-ml-xs"
                  >Compartido</q-chip
                >
                <q-badge
                  :color="
                    progresoResultados >= 100 ? 'green' : progresoResultados >= 50 ? 'amber' : 'red'
                  "
                  text-color="white"
                >
                  {{ progresoResultados }}%
            ...
            <q-tab name="contenidos" no-caps>
              <div class="row items-center q-gutter-sm">
                ...
                <q-badge
                  :color="
                    progresoContenidos >= 100 ? 'green' : progresoContenidos >= 50 ? 'amber' : 'red'
                  "
                  text-color="white"
                >
                  {{ progresoContenidos }}%
            ...
            <q-tab name="estrategias" no-caps>
              <div class="row items-center q-gutter-sm">
                ...
                <q-chip size="xs" color="teal-2" text-color="teal-9" dense class="q-ml-xs"
                  >Personal</q-chip
                >
                <q-badge
                  :color="
                    progresoEstrategias >= 100
                      ? 'green'
                      : progresoEstrategias >= 50
                        ? 'amber'
                        : 'red'
                  "
                  text-color="white"
            ...
            <q-tab name="evaluacion" no-caps>
              <div class="row items-center q-gutter-sm">
                ...
                <q-badge
                  :color="
                    progresoEvaluacion >= 100 ? 'green' : progresoEvaluacion >= 50 ? 'amber' : 'red'
                  "
                  text-color="white"
                >
                  {{ progresoEvaluacion }}%
            ...
            <q-tab name="secuencia" no-caps>
              <div class="row items-center q-gutter-sm">
                ...
                <q-badge
                  :color="
                    progresoSecuencia >= 100 ? 'green' : progresoSecuencia >= 50 ? 'amber' : 'red'
                  "
                  text-color="white"
                >
                  {{ progresoSecuencia }}%
          ...
          <q-tab-panels v-model="tabActual" animated class="bg-transparent">
            ...
            <q-tab-panel name="aprendizaje" class="q-pa-lg">
              ...
              <q-banner class="bg-purple-1 text-purple-9 q-mb-md rounded-borders" dense>
                ...
                <span class="q-ml-sm text-caption"
                  >Estos datos son visibles para todos los docentes de esta materia.</span
                >
                <template v-slot:action v-if="!puedeEditarCompartido">
                  <q-chip color="orange" text-color="white" size="sm" icon="lock"
                    >Solo lectura (Sede)</q-chip
                  >
                </template>
              </q-banner>
              ...
              <div class="q-mb-lg">
                ...
                <q-linear-progress
                  :value="progresoResultados / 100"
                  :color="progresoResultados >= 100 ? 'green' : 'orange'"
                  rounded
                  size="8px"
                />
              </div>
              ...
              <div class="q-mb-xl">
                ...
                <q-input
                  v-model="formTema.resultado_aprendizaje"
                  outlined
                  type="textarea"
                  rows="3"
              ...
              <div>
                <div class="row items-center justify-between q-mb-md">
                  ...
                  <q-btn
                    ...
                    size="sm"
                    no-caps
                    @click="dialogLogro = true"
                  />
                </div>
                <p class="text-body2 q-mb-md" style="color: var(--text-secondary)">
                  Cada logro esperado puede tener múltiples indicadores que evidencian su
                  cumplimiento.
                </p>

                <div
                  v-if="!formTema.logros_esperados?.length"
                ...
                <div v-else class="q-gutter-md">
                  <q-card
                    v-for="logro in formTema.logros_esperados"
                    :key="logro.id"
                    flat
                    bordered
                    class="logro-card"
                  >
                    <q-card-section class="bg-green-1">
                      <div class="row items-center no-wrap">
                        ...
                        >
                          <q-badge
                            v-if="logro.mis_preguntas_count"
                            floating
                            color="teal"
                    ...
                    <q-card-section class="q-pt-sm">
                      <div class="row items-center justify-between q-mb-sm">
                        ...
                        <q-btn
                          ...
                          size="sm"
                          no-caps
                          @click="abrirDialogIndicador(logro)"
                        />
                      </div>

                      <div
                        v-if="!logro.indicadores?.length"
                        class="text-center q-pa-sm bg-grey-1 rounded-borders"
                      >
                        <span class="text-caption text-grey-6"
                          >Sin indicadores. Agrega cómo se evidencia este logro.</span
                        >
                      </div>

                      <q-list v-else dense separator>
                        <q-item
                          v-for="indicador in logro.indicadores"
                          :key="indicador.id"
                          class="q-pl-md"
                        >
                          <q-item-section avatar>
                            <q-chip size="sm" color="blue-2" text-color="blue-9" dense>{{
                              indicador.codigo
                            }}</q-chip>
                          </q-item-section>
                          <q-item-section>
            ...
            <q-tab-panel name="contenidos" class="q-pa-lg">
              ...
              <q-banner class="bg-purple-1 text-purple-9 q-mb-md rounded-borders" dense>
                ...
                <span class="text-weight-medium">Campo Compartido (Materia)</span>
                <span class="q-ml-sm text-caption"
                  >Los contenidos y bibliografía son comunes para todos los docentes.</span
                >
                <template v-slot:action v-if="!puedeEditarCompartido">
                  <q-chip color="orange" text-color="white" size="sm" icon="lock"
                    >Solo lectura (Sede)</q-chip
              ...
              <div class="q-mb-lg">
                ...
                <q-linear-progress
                  :value="progresoContenidos / 100"
                  :color="progresoContenidos >= 100 ? 'green' : 'orange'"
                  rounded
                  size="8px"
                />
              </div>
                ...
                <div class="col-12 col-md-4">
                  <q-card flat bordered class="full-height">
                    ...
                    <q-card-section>
                      <q-list dense>
                        <q-item
                          v-for="(item, idx) in formTema.contenidos.conceptual"
                          :key="idx"
                          class="q-pa-xs"
                        >
                          <q-item-section avatar
                            ><q-icon name="circle" size="8px" color="blue"
                          /></q-item-section>
                          <q-item-section
                            ><q-input
                              v-model="formTema.contenidos.conceptual[idx]"
                              dense
                              borderless
                              :readonly="!puedeEditarCompartido"
                          /></q-item-section>
                          <q-item-section side
                            ><q-btn
                              ...
                              size="xs"
                              color="red"
                              @click="formTema.contenidos.conceptual.splice(idx, 1)"
                          /></q-item-section>
                        </q-item>
                      </q-list>
                      <q-btn
                        ...
                        @click="formTema.contenidos.conceptual.push('')"
                        no-caps
                      />
                    </q-card-section>
                  </q-card>
                ...
                <div class="col-12 col-md-4">
                  <q-card flat bordered class="full-height">
                    ...
                    <q-card-section>
                      <q-list dense>
                        <q-item
                          v-for="(item, idx) in formTema.contenidos.procedimental"
                          :key="idx"
                          class="q-pa-xs"
                        >
                          <q-item-section avatar
                          ...
                          <q-item-section
                            ><q-input
                              v-model="formTema.contenidos.procedimental[idx]"
                              dense
                              borderless
                              :readonly="!puedeEditarCompartido"
                          /></q-item-section>
                          <q-item-section side
                            ><q-btn
                              ...
                              size="xs"
                              color="red"
                              @click="formTema.contenidos.procedimental.splice(idx, 1)"
                          /></q-item-section>
                        </q-item>
                      </q-list>
                      <q-btn
                        ...
                        size="sm"
                        class="q-mt-sm full-width"
                        @click="formTema.contenidos.procedimental.push('')"
                        no-caps
                      />
                    </q-card-section>
                  </q-card>
                ...
                <div class="col-12 col-md-4">
                  <q-card flat bordered class="full-height">
                    ...
                    <q-card-section>
                      <q-list dense>
                        <q-item
                          v-for="(item, idx) in formTema.contenidos.actitudinal"
                          :key="idx"
                          class="q-pa-xs"
                        >
                          <q-item-section avatar
                            ><q-icon name="circle" size="8px" color="purple"
                          /></q-item-section>
                          <q-item-section
                            ><q-input
                              v-model="formTema.contenidos.actitudinal[idx]"
                              dense
                              borderless
                              :readonly="!puedeEditarCompartido"
                          /></q-item-section>
                          <q-item-section side
                            ><q-btn
                              ...
                              size="xs"
                              color="red"
                              @click="formTema.contenidos.actitudinal.splice(idx, 1)"
                          /></q-item-section>
                        </q-item>
                      </q-list>
                      <q-btn
                        ...
                        size="sm"
                        class="q-mt-sm full-width"
                        @click="formTema.contenidos.actitudinal.push('')"
                        no-caps
                      />
                    </q-card-section>
                  </q-card>
              ...
              <div class="q-mt-xl">
                <div class="row items-center justify-between q-mb-md">
                  ...
                  <q-btn
                    ...
                    size="sm"
                    no-caps
                    @click="agregarReferenciaBiblio"
                  />
                </div>
                <p class="text-body2 q-mb-md" style="color: var(--text-secondary)">
                  Selecciona las bibliografías y las páginas donde se encuentra el contenido de este
                  tema.
                </p>

                <div
                  v-if="!formTema.referencias_bibliograficas?.length"
                  class="text-center q-pa-lg bg-grey-1 rounded-borders"
                >
                ...
                <div v-else class="row q-col-gutter-md">
                  <div
                    v-for="(ref, idx) in formTema.referencias_bibliograficas"
                    :key="idx"
            ...
            <q-tab-panel name="estrategias" class="q-pa-lg">
              ...
              <q-banner class="bg-teal-1 text-teal-9 q-mb-md rounded-borders" dense>
                ...
                <span class="q-ml-sm text-caption" v-if="!viendoPlanAjeno"
                  >Estas estrategias son tu configuración personal para esta materia.</span
                >
                <span class="q-ml-sm text-caption" v-else
                  >Viendo planificación personalizada de:
                  <b>{{ nombreDocentePlan || 'Docente' }}</b></span
                >

                <template v-slot:action>
                  <q-chip
                    v-if="viendoPlanAjeno"
                    color="orange"
                    text-color="white"
                    size="sm"
                    icon="lock"
                    >Modo Vista (Superior)</q-chip
                  >
                  <q-chip
              ...
              <div class="q-mb-lg">
                ...
                <q-linear-progress
                  :value="progresoEstrategias / 100"
                  :color="progresoEstrategias >= 100 ? 'green' : 'orange'"
                  rounded
                  size="8px"
                />
              </div>
                  ...
                  <q-card flat bordered class="full-height">
                    <q-card-section class="bg-indigo-1">
                      ...
                      <span class="text-subtitle1 text-weight-bold text-indigo-9"
                        >Metodológicas (Docente)</span
                      >
                    </q-card-section>
                    <q-card-section>
                      <q-input
                        v-model="formTema.estrategias.metodologicas"
                        type="textarea"
                        rows="8"
                        outlined
                        placeholder="Estrategias de enseñanza..."
                        :readonly="!puedeEditarPersonal"
                      />
                    </q-card-section>
                  </q-card>
                </div>
                <div class="col-12 col-md-4">
                  <q-card flat bordered class="full-height">
                    <q-card-section class="bg-teal-1">
                      ...
                      <span class="text-subtitle1 text-weight-bold text-teal-9"
                        >Aprendizaje (Estudiante)</span
                      >
                    </q-card-section>
                    <q-card-section>
                      <q-input
                        v-model="formTema.estrategias.aprendizaje"
                        type="textarea"
                        rows="8"
                        outlined
                ...
                <div class="col-12 col-md-4">
                  <q-card flat bordered class="full-height">
                    ...
                    <q-card-section>
                      <q-list dense>
                        <q-item
                          v-for="(item, idx) in formTema.estrategias.recursos"
                          :key="idx"
                          class="q-pa-xs"
                        >
                          <q-item-section avatar
                            ><q-icon name="check" size="16px" color="orange"
                          /></q-item-section>
                          <q-item-section
                            ><q-input
                              v-model="formTema.estrategias.recursos[idx]"
                              dense
                              borderless
                              :readonly="!puedeEditarPersonal"
                          /></q-item-section>
                          <q-item-section side v-if="puedeEditarPersonal"
                            ><q-btn
                              flat
                              round
                              dense
                              ...
                              size="xs"
                              color="red"
                              @click="formTema.estrategias.recursos.splice(idx, 1)"
                          /></q-item-section>
                        </q-item>
                      </q-list>
                      <q-btn
                        v-if="puedeEditarPersonal"
                        flat
                        color="orange"
                        icon="add"
                        label="Agregar"
                        size="sm"
                        class="q-mt-sm full-width"
                        @click="formTema.estrategias.recursos.push('')"
                        no-caps
                      />
                    </q-card-section>
                  </q-card>
            ...
            <q-tab-panel name="evaluacion" class="q-pa-lg">
              ...
              <q-banner class="bg-teal-1 text-teal-9 q-mb-md rounded-borders" dense>
                ...
                <span class="text-weight-medium">Campo Personal (Docente)</span>
                <span class="q-ml-sm text-caption" v-if="!viendoPlanAjeno"
                  >Define tu propia metodología de evaluación formativa y sumativa.</span
                >
                <span class="q-ml-sm text-caption" v-else
              ...
              <div class="q-mb-lg">
                ...
                <q-linear-progress
                  :value="progresoEvaluacion / 100"
                  :color="progresoEvaluacion >= 100 ? 'green' : 'orange'"
                  rounded
                  size="8px"
                />
              </div>
                ...
                <div class="col-12 col-md-6">
                  <q-card flat bordered>
                    <q-card-section class="bg-cyan-1">
                      ...
                      <span class="text-subtitle1 text-weight-bold text-cyan-9"
                        >Evaluación Formativa</span
                      >
                      <p class="text-caption q-mb-none text-cyan-7">
                ...
                <div class="col-12 col-md-6">
                  <q-card flat bordered>
                    <q-card-section class="bg-red-1">
                      ...
                      <span class="text-subtitle1 text-weight-bold text-red-9"
            ...
            <q-tab-panel name="secuencia" class="q-pa-lg">
              ...
              <q-banner class="bg-teal-1 text-teal-9 q-mb-md rounded-borders" dense>
                ...
                <span class="text-weight-medium">Campo Personal (Docente)</span>
                <span class="q-ml-sm text-caption" v-if="!viendoPlanAjeno"
                  >Organiza los momentos de tu clase según tu metodología.</span
                >
                <span class="q-ml-sm text-caption" v-else
              ...
              <div class="q-mb-lg">
                ...
                <q-linear-progress
                  :value="progresoSecuencia / 100"
                  :color="progresoSecuencia >= 100 ? 'green' : 'orange'"
                  rounded
                  size="8px"
                />
              </div>
              ...
              <div class="row items-center justify-between q-mb-lg">
                <span class="text-h6 text-weight-bold"
                  ><q-icon name="timeline" color="primary" class="q-mr-sm" />Secuencia
                  Didáctica</span
                >
                <q-btn
                  v-if="puedeEditarPersonal"
              ...
              <div
                v-if="!formTema.secuencia_didactica?.length"
              ...
              <div v-else class="q-gutter-md">
                <q-card
                  v-for="(momento, idx) in formTema.secuencia_didactica"
                  :key="momento.id"
                  flat
                  bordered
                  class="momento-card"
                  ...
                  <q-card-section horizontal :class="getMomentoClass(momento.momento)">
                    ...
                    >
                      <div class="text-center full-width q-px-sm">
                        ...
                        <q-chip
                          :clickable="puedeEditarPersonal"
                          :ripple="puedeEditarPersonal"
                          :color="getMomentoColor(momento.momento)"
                          text-color="white"
                          dense
                          size="sm"
                          class="q-mt-sm"
                        >
                          ...
                          <q-tooltip v-if="puedeEditarPersonal"
                            >Clic para cambiar duración</q-tooltip
                          >
                          <q-popup-edit
                            v-if="puedeEditarPersonal"
                            v-model.number="momento.duracion"
                            auto-save
                            v-slot="scope"
                            anchor="top middle"
                            self="bottom middle"
                    ...
                    <q-card-section class="col-auto flex items-start">
                      <div class="column q-gutter-xs" v-if="puedeEditarPersonal">
                        ...
                        />
                        <q-btn
                          v-if="idx < formTema.secuencia_didactica.length - 1"
                          flat
                          round
                          dense
                          icon="arrow_downward"
      ...
      <q-card style="width: 500px; max-width: 95vw; border-radius: 16px">
        <div class="dialog-header" style="background: linear-gradient(135deg, #43a047, #66bb6a)">
          <div class="dialog-header-title">
            <q-icon name="flag" size="28px" />Nuevo Logro Esperado
          </div>
        </div>
    ...
    <q-dialog v-model="dialogIndicador" persistent>
      <q-card style="width: 100%; max-width: 500px; border-radius: 16px">
        <div class="dialog-header" style="background: linear-gradient(135deg, #1976d2, #42a5f5)">
          <div class="dialog-header-title">
            <q-icon name="check_circle" size="28px" />Nuevo Indicador para
            {{ logroSeleccionado?.codigo }}
          </div>
        </div>
        <q-card-section class="q-pt-lg">
          <q-input
    ...
    <q-dialog v-model="dialogSecuencia" persistent>
      <q-card style="width: 550px; max-width: 95vw; border-radius: 16px">
        <div class="dialog-header">
          <div class="dialog-header-title">
            <q-icon name="timeline" size="28px" />{{ editandoSecuencia ? 'Editar' : 'Nuevo' }}
            Momento
          </div>
        </div>
        <q-card-section class="q-pt-lg q-gutter-md">
          <q-select
            v-model="formSecuencia.momento"
            outlined
            dense
            label="Momento"
          ...
          />
          <q-input
            v-model.number="formSecuencia.duracion"
            outlined
            dense
            type="number"
            label="Duración (min)"
          ...
          />
          <q-input
            v-model="formSecuencia.actividad"
            outlined
            type="textarea"
            rows="4"
            label="Actividades"
    ...
    <q-dialog v-model="dialogOtros" persistent>
      <q-card style="width: 500px; max-width: 95vw; border-radius: 16px">
        <div class="dialog-header" style="background: linear-gradient(135deg, #7e57c2, #9575cd)">
          <div class="dialog-header-title">
            <q-icon name="edit_note" size="28px" />Especificar Otra Opción
          </div>
        </div>
        <q-card-section class="q-pt-lg">
          <q-input
...
const progresoTotal = computed(() => {
  return Math.round(
    (progresoResultados.value +
      progresoContenidos.value +
      progresoEstrategias.value +
      progresoEvaluacion.value +
      progresoSecuencia.value) /
      5,
  )
})

const tiempoTotal = computed(
  () => formTema.value.secuencia_didactica?.reduce((s, m) => s + (m.duracion || 0), 0) || 0,
)
...
const optsEvalFormativaActividades = computed(() =>
  getOpcionesConOtros(
    store.opcionesEvaluacionFormativa,
    formTema.value.evaluacion.formativa.actividades,
  ),
)
const optsEvalFormativaInstrumentos = computed(() =>
  getOpcionesConOtros(
    store.opcionesInstrumentosFormativa,
    formTema.value.evaluacion.formativa.instrumentos,
  ),
)
const optsEvalFormativaEvidencias = computed(() =>
  getOpcionesConOtros(
    store.opcionesEvidenciasFormativa,
    formTema.value.evaluacion.formativa.evidencias,
  ),
)

const optsEvalSumativaActividades = computed(() =>
  getOpcionesConOtros(
    store.opcionesEvaluacionSumativa,
    formTema.value.evaluacion.sumativa.actividades,
  ),
)
const optsEvalSumativaInstrumentos = computed(() =>
  getOpcionesConOtros(
    store.opcionesInstrumentosSumativa,
    formTema.value.evaluacion.sumativa.instrumentos,
  ),
)
const optsEvalSumativaEvidencias = computed(() =>
  getOpcionesConOtros(
    store.opcionesEvidenciasSumativa,
    formTema.value.evaluacion.sumativa.evidencias,
  ),
)
...
function calcularProgresoLocal(seccion) {
  ...
  if (seccion === 'contenidos') {
    ...
    if (conceptual.length > 1) {
      conceptual.slice(1).forEach((item) => {
        totalCampos++
    ...
    if (procedimental.length > 1) {
      procedimental.slice(1).forEach((item) => {
        totalCampos++
        if (item?.trim()) camposLlenos++
      })
    }
    ...
    if (actitudinal.length > 1) {
      actitudinal.slice(1).forEach((item) => {
        totalCampos++
        if (item?.trim()) camposLlenos++
      })
    }
    ...
    if (unidad.value) {
      ...
      if (tema.value) {
        ...
        formTema.value = {
          ...
          logros_esperados: (tema.value.logros_esperados || tema.value.logros || []).map(
            (l, index) => ({
              ...l,
          ...
          contenidos: {
            conceptual: [
              ...(tema.value.contenidos?.conceptual || tema.value.contenido_conceptual || []),
            ],
            procedimental: [
              ...(tema.value.contenidos?.procedimental || tema.value.contenido_procedimental || []),
            ],
            actitudinal: [
              ...(tema.value.contenidos?.actitudinal || tema.value.contenido_actitudinal || []),
            ],
          },
          estrategias: {
            metodologicas:
              tema.value.planificacion_personal?.estrategias_metodologicas ||
              tema.value.estrategias?.metodologicas ||
              tema.value.estrategias_metodologicas ||
              '',
            aprendizaje:
              tema.value.planificacion_personal?.estrategias_aprendizaje ||
              tema.value.estrategias?.aprendizaje ||
              tema.value.estrategias_aprendizaje ||
              '',
            recursos: [
              ...(tema.value.planificacion_personal?.estrategias_recursos ||
                tema.value.estrategias?.recursos ||
                tema.value.estrategias_recursos ||
                []),
            ],
          },
          evaluacion: {
            formativa: {
              actividades: [
                ...(tema.value.planificacion_personal?.evaluacion_formativa?.actividades ||
                  tema.value.evaluacion?.formativa?.actividades ||
                  tema.value.evaluacion_formativa?.actividades ||
                  []),
              ],
              instrumentos: [
                ...(tema.value.planificacion_personal?.evaluacion_formativa?.instrumentos ||
                  tema.value.evaluacion?.formativa?.instrumentos ||
                  tema.value.evaluacion_formativa?.instrumentos ||
                  []),
              ],
              evidencias: [
                ...(tema.value.planificacion_personal?.evaluacion_formativa?.evidencias ||
                  tema.value.evaluacion?.formativa?.evidencias ||
                  tema.value.evaluacion_formativa?.evidencias ||
                  []),
              ],
            },
            sumativa: {
              actividades: [
                ...(tema.value.planificacion_personal?.evaluacion_sumativa?.actividades ||
                  tema.value.evaluacion?.sumativa?.actividades ||
                  tema.value.evaluacion_sumativa?.actividades ||
                  []),
              ],
              instrumentos: [
                ...(tema.value.planificacion_personal?.evaluacion_sumativa?.instrumentos ||
                  tema.value.evaluacion?.sumativa?.instrumentos ||
                  tema.value.evaluacion_sumativa?.instrumentos ||
                  []),
              ],
              evidencias: [
                ...(tema.value.planificacion_personal?.evaluacion_sumativa?.evidencias ||
                  tema.value.evaluacion?.sumativa?.evidencias ||
                  tema.value.evaluacion_sumativa?.evidencias ||
                  []),
              ],
            },
          },
          ...
          referencias_bibliograficas: tema.value.referencias_bibliograficas
            ...
            : tema.value.bibliografias
              ? tema.value.bibliografias.map((b) => ({
...
function agregarLogro() {
  ...
  formTema.value.logros_esperados.push({
    id: Date.now(),
    codigo: `LE.${num}`,
    descripcion: nuevoLogro.value,
    indicadores: [],
  })
  nuevoLogro.value = ''
...
function eliminarLogro(logro) {
  ...
  formTema.value.logros_esperados.forEach((l, i) => {
    l.codigo = `LE.${i + 1}`
  })
}
...
function agregarIndicador() {
  ...
  logroSeleccionado.value.indicadores.push({
    id: Date.now(),
    codigo: `IND.${logroNum}.${indNum}`,
    descripcion: nuevoIndicador.value,
  })
  nuevoIndicador.value = ''
...
function eliminarIndicador(logro, indicador) {
  ...
  logro.indicadores.forEach((i, idx) => {
    i.codigo = `IND.${logroNum}.${idx + 1}`
  })
}
...
function guardarSecuencia() {
  if (editandoSecuencia.value && secuenciaSeleccionada.value) {
    const idx = formTema.value.secuencia_didactica.findIndex(
      (s) => s.id === secuenciaSeleccionada.value.id,
    )
...
function eliminarSecuencia(sec) {
  formTema.value.secuencia_didactica = formTema.value.secuencia_didactica.filter(
    (s) => s.id !== sec.id,
  )
}
