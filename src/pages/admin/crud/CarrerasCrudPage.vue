  ...
  <q-page class="q-pa-lg">
    ...
    <div class="row items-center q-mb-lg">
      ...
      <div class="col-auto q-gutter-sm">
        ...
        <q-btn color="primary" icon="add" label="Nueva Carrera" @click="openDialog(null)" :disable="loading" />
      </div>
    </div>
      ...
      <q-card-section>
        <div class="row q-col-gutter-md items-end">
          ...
          <div class="col-12 col-md-2">
            <q-select v-model="filterPlan" :options="planesOptions" label="Plan Malla"
              outlined dense clearable emit-value map-options>
              <template #prepend><q-icon name="account_tree" size="18px" /></template>
            </q-select>
          </div>
          <div class="col-12 col-md-2">
            <q-btn v-if="hasActiveFilters" flat color="negative" label="Limpiar" icon="clear_all"
    ...
    <!-- Tabla -->
    <q-table
      :rows="carrerasFiltradas" :columns="columns" row-key="id"
      :loading="loading" :filter="filter" :pagination="pagination"
      class="shadow-1 carreras-table" flat bordered
    >
    ...
    <q-dialog v-model="showDialog" persistent>
      <q-card style="width:820px; max-width:97vw; max-height:94vh; display:flex; flex-direction:column;">
            ...
            <q-form @submit.prevent="saveCarrera">
              ...
              <div class="form-section q-mb-lg">
                ...
                <div class="row q-col-gutter-md">
                  ...
                  <div class="col-12 col-md-4">
                    <q-select v-model="form.sede_id" :options="sedesFormOptions"
              ...
              <div class="form-section q-mb-lg">
                ...
                <div class="row q-col-gutter-md">
                  ...
                  <div class="col-12 col-md-6">
                    <q-input v-model="form.codigo_api" label="Código API externo" outlined dense clearable
      ...
      <q-card style="min-width:360px">
        ...
        <q-card-section class="q-pt-lg">
          <div v-if="carreraToDelete" class="q-pa-sm bg-grey-2 rounded-borders q-mb-sm">
            ...
            <div><strong>Malla:</strong> {{ carreraToDelete.plan_estudios === 'A' ? 'Antigua' : carreraToDelete.plan_estudios === 'N' ? 'Nueva' : 'Sin definir' }}</div>
          </div>
...
const form = ref({
  id: null, nombre: '', codigo: '', sigla: '', codigo_api: '',
  plan_estudios: null, sede_id: null, activo: true,
  facultad: '', area: '', modificado_localmente: false,
})
...
const sedesMap       = computed(() => { const m = {}; sedesStore.sedes.forEach(s => { m[s.id] = s.nombre }); return m })
...
async function loadData() {
  loading.value = true
  try { await carrerasStore.fetchCarreras() }
  catch (err) { Notify.create({ type: 'negative', message: 'Error: ' + err.message }) }
  finally     { loading.value = false }
}

function clearFilters() { filterSede.value = null; filterPlan.value = null; filter.value = '' }
...
function openDialog(carrera) {
  if (carrera) {
    ...
    form.value = {
      id: null, nombre: '', codigo: '', sigla: '', codigo_api: '',
      plan_estudios: null, sede_id: filterSede.value || null,
      activo: true, facultad: '', area: '', modificado_localmente: false,
    }
  }
...
function confirmDelete(c) { carreraToDelete.value = c; showDeleteDialog.value = true }
...
.carreras-table { border-radius: 12px; overflow: hidden; }
